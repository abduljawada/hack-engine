...
| Ruffle | Existing WebAssembly scanner plus runtime-specific number-format hints | Ruffle detection applies to the captured module, not every module sharing its page. |
