...
Current work is an unpublished **1.2.4 candidate**. Use [IMPLEMENTATION_1_0.md](IMPLEMENTATION_1_0.md) for current test evidence and remaining release gates. Historical checked entries below describe the August 0.7.0 preparation and do not certify the new candidate.
