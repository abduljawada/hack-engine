...
export const extensionUiScenario = `(${async function () {
  ...
  if (ui('[aria-label^="Watch label"]').value !== 'Practice score' || ui('[aria-label^="Group for"]').value !== 'Practice') throw new Error('Watch metadata lost when reselecting a candidate');
